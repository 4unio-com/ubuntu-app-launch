...
protected:
    ...
    virtual void SetUp()
    {
        ...
        dbus_test_dbus_mock_object_add_method(mock, obj, "GetJobByName", G_VARIANT_TYPE("s"), G_VARIANT_TYPE("o"),
                                              "ret = dbus.ObjectPath('/com/test/job')", NULL);

        DbusTestDbusMockObject* jobobj =
            dbus_test_dbus_mock_get_object(mock, "/com/test/job", "com.ubuntu.Upstart0_6.Job", NULL);

        dbus_test_dbus_mock_object_add_method(mock, jobobj, "Start", G_VARIANT_TYPE("(asb)"), NULL, "", NULL);
    ...
    inline void StartCheckEnv(const std::string& appid, std::map<std::string, std::function<void(const gchar*)>> enums)
    {
        ...
        DbusTestDbusMockObject* obj =
            dbus_test_dbus_mock_get_object(mock, "/com/test/job", "com.ubuntu.Upstart0_6.Job", nullptr);
        ...
        const DbusTestDbusMockCall* calls =
            dbus_test_dbus_mock_object_get_method_calls(mock, obj, "Start", &len, nullptr);
...
static void nocheck(const gchar*)
{
}
...
#define APP_DIR CMAKE_SOURCE_DIR "/click-root-dir/.click/users/test-user/com.test.good"
    ...
    StartCheckEnv(
        ...
        {
            {"UBUNTU_APPLICATION_ISOLATION", [](const gchar* value) { EXPECT_STREQ("1", value); }},
            {"XDG_CACHE_HOME", nocheck},
            {"XDG_CONFIG_HOME", nocheck},
            {"XDG_DATA_HOME", nocheck},
            {"XDG_RUNTIME_DIR", nocheck},
            {"XDG_DATA_DIRS", [](const gchar* value) { EXPECT_TRUE(g_str_has_prefix(value, APP_DIR ":")); }},
            {"TMPDIR", [](const gchar* value) { EXPECT_TRUE(g_str_has_suffix(value, "com.test.good")); }},
            {"__GL_SHADER_DISK_CACHE_PATH",
             [](const gchar* value) { EXPECT_TRUE(g_str_has_suffix(value, "com.test.good")); }},
            {"APP_DIR", [](const gchar* value) { EXPECT_STREQ(APP_DIR, value); }},
            {"APP_EXEC", [](const gchar* value) { EXPECT_STREQ("grep", value); }},
            {"APP_ID", [](const gchar* value) { EXPECT_STREQ("com.test.good_application_1.2.3", value); }},
            {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("com.test.good_application_1.2.3", value); }},
            {"APP_LAUNCHER_PID", [](const gchar* value) { EXPECT_EQ(getpid(), atoi(value)); }},
            {"APP_DESKTOP_FILE_PATH", [](const gchar* value) { EXPECT_STREQ(APP_DIR "/application.desktop", value); }},
            {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("0", value); }},
...
TEST_F(ExecUtil, DesktopExec)
{
    StartCheckEnv("foo",
                  {
                      {"APP_EXEC", [](const gchar* value) { EXPECT_STREQ("foo", value); }},
                      {"APP_DESKTOP_FILE_PATH",
                       [](const gchar* value) { EXPECT_STREQ(CMAKE_SOURCE_DIR "/applications/foo.desktop", value); }},
                      {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("unconfined", value); }},
                      {"APP_ID", [](const gchar* value) { EXPECT_STREQ("foo", value); }},
                      {"INSTANCE_ID", nocheck},
                      {"APP_LAUNCHER_PID", [](const gchar* value) { EXPECT_EQ(getpid(), atoi(value)); }},
                      {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("0", value); }},
                  });
...
TEST_F(ExecUtil, DesktopMir)
{
    StartCheckEnv("xmir",
                  {
                      {"APP_EXEC", [](const gchar* value) { EXPECT_STREQ("libertine-launch xfoo", value); }},
                      {"APP_DESKTOP_FILE_PATH",
                       [](const gchar* value) { EXPECT_STREQ(CMAKE_SOURCE_DIR "/applications/xmir.desktop", value); }},
                      {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("unconfined", value); }},
                      {"APP_ID", [](const gchar* value) { EXPECT_STREQ("xmir", value); }},
                      {"INSTANCE_ID", nocheck},
                      {"APP_LAUNCHER_PID", [](const gchar* value) { EXPECT_EQ(getpid(), atoi(value)); }},
                      {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("1", value); }},
                  });
}
...
TEST_F(ExecUtil, DesktopNoMir)
{
    StartCheckEnv(
        "noxmir",
        {
            {"APP_EXEC", [](const gchar* value) { EXPECT_STREQ("noxmir", value); }},
            {"APP_DESKTOP_FILE_PATH",
             [](const gchar* value) { EXPECT_STREQ(CMAKE_SOURCE_DIR "/applications/noxmir.desktop", value); }},
            {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("unconfined", value); }},
            {"APP_ID", [](const gchar* value) { EXPECT_STREQ("noxmir", value); }},
            {"INSTANCE_ID", nocheck},
            {"APP_LAUNCHER_PID", [](const gchar* value) { EXPECT_EQ(getpid(), atoi(value)); }},
            {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("0", value); }},
        });
    ...
    StartCheckEnv("com.test.mir_mir_1",
                  {
                      ...
                      {"APP_DIR", nocheck},
                      {"APP_EXEC", nocheck},
                      {"APP_ID", [](const gchar* value) { EXPECT_STREQ("com.test.mir_mir_1", value); }},
                      {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("com.test.mir_mir_1", value); }},
    ...
    StartCheckEnv("com.test.mir_nomir_1",
                  {
                      ...
                      {"APP_DIR", nocheck},
                      {"APP_EXEC", nocheck},
                      {"APP_ID", [](const gchar* value) { EXPECT_STREQ("com.test.mir_nomir_1", value); }},
                      {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("com.test.mir_nomir_1", value); }},
                      {"APP_LAUNCHER_PID", nocheck},
                      {"APP_DESKTOP_FILE_PATH", nocheck},
                      {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("0", value); }},
                      {"QML2_IMPORT_PATH", nocheck},
...
{
    StartCheckEnv(
        "container-name_test_0.0",
        {
            {"APP_EXEC",
             [](const gchar* value) { EXPECT_STREQ("libertine-launch \"--id=container-name\" test", value); }},
            {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("unconfined", value); }},
            {"APP_ID", [](const gchar* value) { EXPECT_STREQ("container-name_test_0.0", value); }},
            {"APP_LAUNCHER_PID", [](const gchar* value) { EXPECT_EQ(getpid(), atoi(value)); }},
            {"INSTANCE_ID", nocheck},
            {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("1", value); }},
        });
...
TEST_F(ExecUtil, LibertineExecUser)
{
    StartCheckEnv(
        ...
        {
            {"APP_EXEC",
             [](const gchar* value) { EXPECT_STREQ("libertine-launch \"--id=container-name\" user-app", value); }},
            {"APP_EXEC_POLICY", [](const gchar* value) { EXPECT_STREQ("unconfined", value); }},
            {"APP_ID", [](const gchar* value) { EXPECT_STREQ("container-name_user-app_0.0", value); }},
            {"APP_LAUNCHER_PID", [](const gchar* value) { EXPECT_EQ(getpid(), atoi(value)); }},
            {"INSTANCE_ID", nocheck},
            {"APP_XMIR_ENABLE", [](const gchar* value) { EXPECT_STREQ("1", value); }},
        });
