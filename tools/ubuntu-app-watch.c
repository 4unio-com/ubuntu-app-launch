...
void starting(const gchar* appid, gpointer user_data) {
  g_print("Starting %s\n", appid);
  return;
}

void started(const gchar* appid, gpointer user_data) {
  g_print("Started  %s\n", appid);
  return;
}

void stopped(const gchar* appid, gpointer user_data) {
  g_print("Stop     %s\n", appid);
  return;
}

void resumed(const gchar* appid, GPid* pids, gpointer user_data) {
  g_print("Resumed  %s\n", appid);
  return;
}

void paused(const gchar* appid, GPid* pids, gpointer user_data) {
  g_print("Paused   %s\n", appid);
  return;
}

void focus(const gchar* appid, gpointer user_data) {
  g_print("Focus    %s\n", appid);
  return;
}

void fail(const gchar* appid, UbuntuAppLaunchAppFailed failhow,
          gpointer user_data) {
