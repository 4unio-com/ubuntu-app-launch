...
static gboolean evaluate_dir(const gchar* dir, const gchar* desktop, gchar** appdir, gchar** appdesktop)
{
...
static gboolean app_info_legacy(const gchar* appid, gchar** appdir, gchar** appdesktop)
{
...
static gboolean app_info_libertine(const gchar* appid, gchar** appdir, gchar** appdesktop)
{
    ...
    gchar* desktopdir =
        g_build_filename(g_get_user_cache_dir(), "libertine-container", container, "rootfs", "usr", "share", NULL);
    ...
    if (!g_file_test(desktopfile, G_FILE_TEST_EXISTS))
    {
        ...
        desktopdir = g_build_filename(g_get_user_data_dir(), "libertine-container", "user-data", container, ".local",
                                      "share", NULL);
...
static gboolean app_info_click(const gchar* appid, gchar** appdir, gchar** appdesktop)
{
    gchar* package = NULL;
