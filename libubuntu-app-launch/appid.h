...
/** \brief The set of information that is used to uniquely identify an
    ...
    the package to resolve problems with upgrades and reduce race conditions
   that
    ...
    here that search in various ways for the current version so higher level
   apps
...
struct AppID {
  ...
  /** Empty constructor for an AppID. Makes coding with them easier, but
     generally
  ...
  /** Constructor for an AppID if all the information is known about the
     package.
  ...
  */
  ...
  /** Find is a more tollerant version of parse(), it handles legacy
     applications,
  ...
  */
  ...
  /** Control how the application list of a package is searched in the
     discover()
      functions. */
  ...
  */
  ...
  /** Create an AppID providing known strings of packages and names
      ...
      \param version Version of the package
  */
  static AppID discover(const std::string& package, const std::string& appname,
