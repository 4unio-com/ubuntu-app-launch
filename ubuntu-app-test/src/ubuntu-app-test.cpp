...
void app_failed(const gchar* appid, UbuntuAppLaunchAppFailed failure_type, gpointer ploop)
{
...
void fd_getter(MirPromptSession* session, size_t count, int const* fdsin, void* pfds)
{
